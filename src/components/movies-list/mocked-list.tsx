...
export const mockedMoviesList = [{
  ...
  },
  {
    ...
    poster_path: 'https://image.tmdb.org/t/p/w500/e4DGlsc9g0h5AyoyvvAuIRnofN7.jpg',
  ...
  },
  {
    ...
    poster_path: 'https://image.tmdb.org/t/p/w500/8K6pfMcT3hiIlCFw2RrHoXLshxl.jpg',
    overview: 'A pilot battles to save his family and the planet after an experiment for unlimited energy goes wrong.',
    budget: 1000000,
    revenue: 0,
    genres: [
      'Science Fiction',
  ...
  },
  {
    ...
    poster_path: 'https://image.tmdb.org/t/p/w500/zm0ODjtfJfJW0W269LqsQl5OhJ8.jpg',
    // tslint:disable-next-line:max-line-length
  ...
  },
  {
    ...
    poster_path: 'https://image.tmdb.org/t/p/w500/zqTlUUBlVZTzVMYUnJQve0kJc3o.jpg',
    // tslint:disable-next-line:max-line-length
